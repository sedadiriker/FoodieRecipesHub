...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-[#FEFEF6]">
      ...
      <div className="nav-1 m-auto w-11/12 flex items-center justify-between md:justify-evenly border-b border-b-main">
        ...
        <div className={`${
          ...
          <form
            ...
            className="search-div flex items-stretch h-12 w-6/12 "
          >
            <input
      ...
      <div className={`${
            show ? "flex flex-col pb-2" : "hidden"
          } md:flex md:flex-row  items-center justify-between nav-2 w-full bg-main border-b-8 border-b-secondaryColor`}>
